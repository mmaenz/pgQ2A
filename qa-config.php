...
*/
	...
	define('QA_PDO_USERNAME', 'q2a');
	define('QA_PDO_PASSWORD', 'q2a');
	define('QA_PDO_DATABASE', 'q2a');
	define('QA_PDO_PORT', '5432');
	define('QA_PDO_DBTYPE', 'pgsql');
/*
